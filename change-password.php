...
<head>
    ...
    <title>AUTOMOBILE SERVICE CENTER MANAGEMENT</title>
        ...
        <div class="row h-100">
            ...
            <div class="col-12 align-self-center text-center">
                <div class="loader-logo">
                    <div class="logo">A<span>AS</span><span>CM</span>
                    ...
                    <h4 class="logo-text"><span>AUTOMOBILE SERVICE</span><small>CENTER MANAGEMENT</small></h4>
                </div>
            </div>
        ...
        <nav class="navbar">
            ...
            <div>
                <a class="navbar-brand" href="index.php">
                    <div class="logo">1<span>AS</span><span>CM</span></div>
                    <h4 class="logo-text"><span>Automobile</span><small>Service Center Management</small></h4>
                </a>
            </div>
            <div>
    ...
    <main class="flex-shrink-0 main-container">
        ...
        <div class="banner-hero vh-100 scroll-y bg-dark">
            <div class="background opac">
                <img src="assets/img/download4.jpg" alt="">
            </div>
            <div class="container h-100 text-white">
                <div class="row h-100 h-sm-auto">
                    <div class="col-12 col-md-8 col-lg-5 col-xl-4 mx-auto align-self-center text-center">
                        <h5 class="font-weight-light mb-1 text-mute">Thank you,</h5>
                        <h3 class="font-weight-normal mb-4">Change Password</h3>
                        <p>In order to change password you can fill below details</p>
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" id="inputPassword1" class="form-control form-control-lg border-0" placeholder="Confirm Password" required="">
                        </div>
                      
                        <div class="mb-4">
                            <a href="index.php" class=" btn btn-lg btn-default default-shadow btn-block">Update <span class="ml-2 icon arrow_right"></span></a>
                        </div>
                    </div>
                </div>
            </div>
