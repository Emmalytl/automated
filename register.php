    ...
    <main class="flex-shrink-0 main-container">
        ...
        <div class="banner-hero vh-100 scroll-y bg-dark">
            <div class="background opac">
                <img src="assets/img/download2.jpg" alt="">
            </div>
            <div class="container h-100 text-white">
                <div class="row h-100 h-sm-auto">
                    <div class="col-12 col-md-8 col-lg-5 col-xl-4 mx-auto align-self-center text-center">
                        ...
                        <div class="mb-4">
                            <a href="register.php" class=" btn btn-lg btn-default default-shadow btn-block">Sign Up <span class="ml-2 icon arrow_right"></span></a>
                        </div>
                        <div class="mb-4">
                            <p>
                                Already have account? Please <a href="index.php">Sign In</a> here.
                            </p>
                        </div>
                    </div>
                </div>
