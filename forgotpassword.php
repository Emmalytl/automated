    ...
    <main class="flex-shrink-0 main-container">
        ...
        <div class="banner-hero vh-100 scroll-y bg-dark">
            <div class="background opac">
                <img src="assets/img/download3.jpg" alt="">
            </div>
            <div class="container h-100 text-white">
                <div class="row h-100 h-sm-auto">
                    <div class="col-12 col-md-8 col-lg-5 col-xl-4 mx-auto align-self-center text-center">
                        <h5 class="font-weight-light mb-1 text-mute">Sorry for being here</h5>
                        <h3 class="font-weight-normal mb-4">Reset Password</h3>
                        <p>In order to reset password , provide your registered email address</p>
                        ...
                        <div class="mb-4">
                            <a href="change-password.php" class=" btn btn-lg btn-default default-shadow btn-block">Reset Password <span class="ml-2 icon arrow_right"></span></a>
                        </div>
                    </div>
                </div>
            </div>
